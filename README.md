...
- Ouvrir votre terminal intégré (cmd) dans le dossier.
...
Le programme ouvert est constitué d'une calculatrice pouvant effectuer des additions, des soustractions, des multiplications et des divisions.
...
### ATTENTION: 
- La calculatrice ne peut pas prendre en charge les opérations sur des numéros signés.
- La touche "C" doit être appuyée après un message d'erreur, sans quoi une nouvelle erreur sera toujours affichée.

## Tests
Vous pourrez trouver tous les tests du projet dans le dossier "source/tests".
Fiez-vous au fichier "source/tests/README" pour savoir comment utiliser les fichiers de test.

## Contributions
- PlayeerOne (10/20/2025) : Création du dépôt git initial
- TCholette (02/27/2026) : Rédaction de tous les documents README, Fusion des branches 
- RadioFloyd2351 (02/27/2026) : Rédaction de la documentation dans les fichiers de code, création des fichiers de test, création des issues, création des branches de résolution de problèmes et résolution des problèmes
